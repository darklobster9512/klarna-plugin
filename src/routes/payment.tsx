      ...
      <div className="relative flex h-[calc(100vh-2rem)] max-h-[1043px] w-[600px] max-w-full flex-col overflow-y-auto rounded-2xl bg-white p-8 shadow-xl sm:p-10">
        ...
        <div className="flex flex-1 flex-col">
          ...
          <button
            type="button"
            disabled={!selected}
            className="mt-8 w-full rounded-full bg-[#0b051d] py-4 text-[15px] font-semibold text-white transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
          >
            Weiter
          </button>
        </div>
