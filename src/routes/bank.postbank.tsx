...
export const Route = createFileRoute("/bank/postbank")({
  head: () => ({
    meta: [
      { title: "Postbank — Login" },
      { name: "description", content: "Melde dich bei der Postbank mit deinen Onlinebanking-Daten an." },
      { property: "og:title", content: "Postbank — Login" },
      { property: "og:description", content: "Melde dich bei der Postbank mit deinen Onlinebanking-Daten an." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
    ],
  }),
  component: PostbankLoginPage,
});

function PostbankLoginPage() {
  const logo = bankLogoUrls["postbank"];
      ...
      <div className="mx-auto flex w-[600px] max-w-full items-start justify-center">
        <div className="flex mt-6 h-[calc(100vh-1.5rem)] sm:mt-0 sm:h-[calc(100vh-2rem)] max-h-none sm:max-h-[1043px] w-full flex-col overflow-hidden bg-white rounded-t-[32px] sm:rounded-2xl shadow-xl">
          ...
          <div className="flex flex-1 flex-col overflow-y-auto px-8 pb-6 sm:px-10">
            ...
            <h1 className="mt-4 text-[24px] font-bold leading-tight text-[#0b051d]">Postbank</h1>
